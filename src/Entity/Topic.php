...
class Topic
{
     ...
     * @Assert\NotNull(message="Le champs ne peut pas être null")
     * @Assert\Length(min=3, minMessage="Au moins 3 caractères", max=255, maxMessage="Pas plus de 255 caractères")
     */
    private $name;
